...
export default class Report extends React.Component {
    ...
    handleSend = () => {
        ...
        email(to, {
            ...
            body: "I am reporting " + post['name'] + `\n\n` + `This is why I am reporting this user:  \n` + this.state.text
        }).catch(console.error)
    }
    ...
    render() {
        return (
            <KeyboardAvoidingView keyboardVerticalOffset = {150} behavior = {'padding'} style ={styles.container}>
                ...
                <View style = {{top: "20%"}}>
                    <Text style ={{fontSize: 27, color: "#F76C6C",marginLeft: 27, alignSelf: 'center',lineHeight: 35,textAlign: 'center'}}>{`Why are you reporting this user?`}</Text>
