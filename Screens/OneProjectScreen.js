...
renderPost = design => {      
    ...
    fillProjects = () => { 
        ...
        const tempDesigns = db.collection("projects").doc(projectID).collection("projectPosts")
        db.collection("projects").doc(projectID).collection('projectPosts').get().then(function(querySnapshot) {
